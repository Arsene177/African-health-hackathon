  ...
  return (
    ...
    <div className="about-us-container">
      <div className="about-us-hero">
        <h1>Welcome to <span>HEALTH TRACK</span></h1>
        ...
        <section className="about-us-team">
          ...
          <div className="team-members">
            <div className="team-member">
              <img src="./Arsene.jpeg" alt="Team Member 1" />
              <h3>TSAKENG DANIEL</h3>
              <p>Back-end Developper </p>
            </div>
            <div className="team-member">
              <img src="./team-member2.jpg" alt="Team Member 2" />
              <h3>Jessyca Ebanda</h3>
              <p>Front-end debelopper</p>
            </div>
            <div className="team-member">
              <img src="./team-member3.jpg" alt="Team Member 2" />
              <h3>Dr Zogo Kenneth</h3>
              <p>Marketing Mannager</p>
            </div>
            <div className="team-member">
              <img src="./team-member3.jpg" alt="Team Member 2" />
              <h3>Kokou Parfait Toke</h3>
              <p>Marketing Mannager</p>
            </div>
